...
$mailResult = ''; // Sonucu saklayacak değişken
...
if (isset($_POST['testMail'])) {
    ...
    $siteTitle = $settingsData['title']; // title değerini al

    $mail = new PHPMailer(true); // PHPMailer'i başlatıyoruz
    try {
        $mail->isSMTP();
        ...
        $mail->isHTML(true);
        $mail->CharSet = 'UTF-8'; // Charset ayarını ekleyin
